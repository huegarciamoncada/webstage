    ...
    <div class="row">
        <div class="col-md-12">            
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-8"><?php echo substr($result['description'],0,100);?></div><div class="col-md-4"><a href="http://huegarciamoncada.fr/webstage/index.php/detail?id=<?php echo $result['id'] ?>">voir Anonce</a></div>                 
                </div> 
                <br>                       
                    <?php } ?>                  
